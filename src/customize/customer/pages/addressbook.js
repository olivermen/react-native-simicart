...
class AddressBookPage extends SimiPageComponent {
    ...
    constructor(props) {
        ...
        this.screen = this.props.navigation.getParam('screen') ? this.props.navigation.getParam('screen') : null;
    ...
    checkExistData() {
        if (this.props.data && this.props.data.addresses) {
...
const mapStateToProps = (state) => {
    return {
        data: state.redux_data.address_book_data,
