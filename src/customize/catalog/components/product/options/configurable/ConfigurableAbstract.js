...
class ConfigurableAbstract extends OptionAbstract {
    ...
    renderOptions = () => {
        ...
        objOptions.forEach(attribute => {
            ...
            let element = (
                <View key={Identify.makeid()} style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
                    <Text style={{ fontFamily: material.fontBold, marginRight: 20, fontSize: 16 }}>{Identify.__(attribute.label)}</Text>
