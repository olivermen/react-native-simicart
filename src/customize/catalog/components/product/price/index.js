...
class Price extends React.Component {
    ...
    renderGiftCardPrice() {
        if (this.type == 'giftvoucher' && this.props.product && this.props.product.gift_type && this.props.product.gift_type == '1') {
            return (
                <View style={{ flexDirection: 'row', marginTop: 5 }}>
                    <Text style={{ marginRight: 5, fontFamily: material.fontBold }}>{Identify.__('Gift Card value')}:</Text>
                    <Format price={this.props.product.gift_value} />
                </View>
            );
        }
        return null;
