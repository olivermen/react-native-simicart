...
class Home extends SimiPageComponent {
    ...
    getPreSelectedStore = async () => {
        const store = await AppStorage.getData('storeC&C')
        if (store) {
            this.props.storeData('selected_store', JSON.parse(store));
        }
    }
    ...
    renderLayout() {
        if (this.layout == 'default') {
            ...
            HomeContent = require('../../../core/screens/home/pages/matrix').default;
            return <HomeContent navigation={this.props.navigation} />
...
const mapStateToProps = (state) => {
    return {
        ...
        store: state.redux_data.selected_store
    };
}
//Save to redux.
