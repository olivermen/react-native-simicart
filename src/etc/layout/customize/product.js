...
export default {
    ...
    content: {
        default_alert: {
            active: true,
            sort_order: 1000,
            content: require('../../../customize/catalog/components/product/alert').default,
            position: 'left'
        },
        ...
        default_option: {
            active: true,
            sort_order: 4000,
            content: require('../../../customize/catalog/components/product/options').default,
            position: 'right'
        },
        default_description: {
            active: true,
        ...
        default_related: {
            active: true,
            sort_order: 7000,
            content: require('../../../customize/catalog/components/product/related').default,
            data: {
                api: products,
                param: {
                    limit: 10,
